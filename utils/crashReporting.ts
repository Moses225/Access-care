...
// Extract a safe, loggable error summary
...
export function logError(error: any, context: string): {
  ...
  // Production: send scrubbed error to crash reporting service
  // Replace this comment with Sentry/Bugsnag integration before launch:
  // Sentry.captureException(new Error(safe.message), { extra: { context, ...safe } });
